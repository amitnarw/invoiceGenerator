...
export default function Home() {
  ...
  return (
    <main className="flex justify-center items-center">
      <div className="w-full flex lg:px-16 px-4 lg:gap-10 gap-4 mt-10 lg:flex-row flex-col mb-20">
        <div className="bg-white h-full lg:w-5/6 w-full rounded-xl p-5">
          <div className="flex justify-between lg:flex-row flex-col">
            ...
            ></input>
            <button
              className="text-gray-400 bg-[#f5f5f5] py-12 rounded-md border-[1px] border-[#d5dbe2] flex gap-3 hover:bg-[#EBEBEB] duration-300 justify-center items-center w-52"
          ...
          <div className="flex mt-8 bg-[#192a56] text-white rounded-lg">
            ...
            <input
              ...
              value={text.quantity}
              onChange={handleSetText}
              className="inputHoverShowWhite w-1/12 text-center"
              style={{ padding: "0px" }}
            />
            <input
              type="text"
            ...
            <div className="lg:w-1/2 w-full flex">
              <div className="flex flex-col gap-1 w-full">
                ...
                <div className="flex justify-end mr-10 mt-2">
                  <button className="flex gap-1 items-center text-[#16a085] hover:text-[#0f7b65] text-sm px-4 py-2">
                    <IoMdAdd />
                    Tax
                  </button>
                  <button className="flex gap-1 items-center text-[#16a085] hover:text-[#0f7b65] text-sm px-4 py-2">
        ...
        <div className="lg:w-1/6 w-full mt-5 flex flex-col gap-6">
          <button className="bg-[#1abc9c] hover:bg-[#16a085] p-2 rounded-lg flex items-center justify-center gap-2 text-white lg:w-full w-1/3 duration-300">
            <FiDownload size={15} />
            Download
          </button>
          <hr />
